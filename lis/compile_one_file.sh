...
if [ $# -lt 1 ]; then
  ...
  echo "Example: $0 surfacemodels/land/noahmp.4.0.1/da_gpsdisp/noahmp401_gpsdisp_DAlogMod.F90"
  exit 1
fi
...
echo "Compiling file: ${FILE_PATH}"
./compile -j1 ${FILE_PATH}

# Now rebuild the executable
