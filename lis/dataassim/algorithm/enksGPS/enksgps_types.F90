...
!BOP
! 
! !MODULE: enksgps_types
! 
! !DESCRIPTION: 
! This module contains the definition of types for the GPS EnKS data assimilation
! 
! !REVISION HISTORY: 
!   reichle, 19 Jul 2005
...
module enksgps_types  
  ...
  type :: obs_type
     ...
     real             :: lon       ! longitude
     real             :: lat       ! latitude
     real             :: value     ! value of measurement (vertical displacement in mm for GPS)
