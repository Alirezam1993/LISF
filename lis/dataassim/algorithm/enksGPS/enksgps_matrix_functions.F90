...
!BOP
! 
! !MODULE: enksgps_matrix_functions
! 
...
! \label{row_third_moment_enksgps}
! 
! !INTERFACE:   
...
! \label{five_number_summary_enksgps}
!  
! !INTERFACE: 
...
end module enksgps_matrix_functions
