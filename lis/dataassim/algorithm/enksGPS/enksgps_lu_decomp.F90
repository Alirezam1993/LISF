...
!
!BOP
! !ROUTINE: enksgps_ludcmp
!  \label{enksgps_ludcmp}
! 
! !DESCRIPTION:
...
!
! !INTERFACE: 
SUBROUTINE enksgps_ludcmp(a,n,indx)
!EOP
  implicit none
  ...
  do i=1,n
     ...
     enddo
     if (aamax.eq.0.) print*,'singular matrix in enksgps_ludcmp'
     vv(i)=1./aamax
  enddo
  do j=1,n
     do i=1,j-1
  ...
  enddo
  return
END SUBROUTINE enksgps_ludcmp

  
!BOP
! !ROUTINE: enksgps_lubksb
! \label{enksgps_lubksb}
! 
! !DESCRIPTION:
!
...
!  determined by the routine enksgps\_ludcmp. indx[1..n] is input as the permutation
!  vector returned by enksgps\_ludcmp. b[1..n] is input as the right-hand side
...
!  
! !INTERFACE: 
SUBROUTINE enksgps_lubksb(a,n,indx,b)
!EOP  
  implicit none
